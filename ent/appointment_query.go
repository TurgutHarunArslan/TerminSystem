...
func (aq *AppointmentQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (aq *AppointmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(appointment.Table, appointment.Columns, sqlgraph.NewFieldSpec(appointment.FieldID, field.TypeInt))
	_spec.From = aq.sql
